...
values('NguyenThanhToan', 'Abc123', N'Nguyễn Thanh Toàn', '0934519015', 'nguyenthanhtoan@gmail.com', 0, N'TP. Hồ Chí Minh');

insert into KhachHang(TaiKhoanKH, MatKhauKH, HoVaTen, SDT, Email, GioiTinh, DiaChi)
values('NguyenTienEm', 'Abc123', N'Nguyễn Tiến Em', '0974525152', 'nguyentienem@gmail.com', 0, N'TP. Hà Nội');

insert into KhachHang(TaiKhoanKH, MatKhauKH, HoVaTen, SDT, Email, GioiTinh, DiaChi) 
values('PhanHoangDuy', 'Abc123', N'Phan Hoàng Duy', '0348212365', 'phanhoangduy@gmail.com', 0, N'TP. Đà Nẵng');

insert into KhachHang(TaiKhoanKH, MatKhauKH, HoVaTen, SDT, Email, GioiTinh, DiaChi) 
values('PhanQuang', 'Abc123', N'Phan Quang', '0972132542', 'phanquang@gmail.com', 0, N'TP. Vinh');

insert into KhachHang(TaiKhoanKH, MatKhauKH, HoVaTen, SDT, Email, GioiTinh, DiaChi) 
values('NguyenTienPhuong', 'Abc123', N'Nguyễn Tiến Phương', '0965251451', 'nguyentienphuong@gmail.com', 1, N'TP. Hồ Chí Minh');
go
...
insert into NhanVien(TaiKhoanNV, MatKhauNV, HoVaTen, SDT, Email, GioiTinh, DiaChi, TrangThai, NgaySinh)
values ('huyen', 'abc123', N'Thu Ngân', '0542512465', 'huyen@gmail.com', 1,N'TP. Đà Nẵng', default, '08/09/1994');
insert into NhanVien(TaiKhoanNV, MatKhauNV, HoVaTen, SDT, Email, GioiTinh, DiaChi, TrangThai, NgaySinh)
...
values (N'Lê Hoàng Nam', '03/02/2000', N'120 Nguyễn Tất Thành','0974521251', N'Đà Nẵng', N'Hải Châu', N'Thanh Khê', N'05/02/2000', 120000, 0,'NguyenThanhToan');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Lê Hoàng Nam', '05/02/2021', N'75 Tô Hoài','0974521251', N'Hà Nội', N'Ba Vì', N'Xã Ba Vì', N'08/02/2021', 300000, 0,'NguyenThanhToan');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Văn Thanh', '06/02/2021', N'12/2B Điện Biên Phủ','0974521251', N'Hà Nội', N'Ba Vì', N'Cẩm Lĩnh', N'09/02/2021', 600000, 0,'NguyenTienEm');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Công Phượng', '07/02/2021', N'01 Lê Duẩn','0974521251', N'Đà Nẵng', N'Ba Vì', N'Ba Trại', N'12/02/2021', 700000, 0,'PhanQuang');
insert into DonHang(TenNguoiNhan, NgayDat, DiaChi, SDT, ThanhPho, Quan, Phuong, NgayGiao, TongTien, TrangThai, TaiKhoanKH)
values (N'Văn Lâm', '08/02/2021', N'93 Phan Đăng Lưu','0974521251', N'Hà Nội', N'ba Vì', N'Cổ Đô', N'09/02/2021', 1200000, 0,'NguyenTienPhuong');
go
...
values('NguyenThanhToan', 1, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('NguyenThanhToan', 2, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('NguyenTienEm', 3, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('PhanHoangDuy', 4, 'Điện Thoại giá rẽ, chất lượng', default);
insert into BinhLuan(TaiKhoanKH, MaSanPham, NoiDungBinhLuan, NgayBinhLuan)
values('PhanQuang', 5, 'Điện Thoại giá rẽ, chất lượng', default);
go
